...
import Ico_Ouro from '../../../../assets/icons/Ouro.ico'
...
import Ico_Diamante from '../../../../assets/icons/Diamante.ico'
...
export default function FormDadosGerais(props){
    ...
    let nivelContaNome = dadosStatus.nivelContaNome ? dadosStatus.nivelContaNome : "Gratuita"
        ...
        <div className="progresso-casamentos__container">
            {props.nivelConta == 1 ? (
                <div className='formCardPlanosContainer'>
                    ...
                    <h3>Nivel da conta: <span className="nivel-conta-text">{nivelContaNome}</span></h3>
                    ...
                    <div className="progresso-casamentos">
                        ...
                        <div className="progresso-casamentos-status right">
                            <img className="status-conta-ico" src={carregarStatus(nivelContaNome, proximoNivel)} />
...
function carregarStatus(nivelConta, status){
    ...
    if(nivelConta == "Ouro" && (status == undefined || status == '')){ return Ico_Ouro }
    ...
    if(nivelConta == "Diamante" && (status == undefined || status == '')){ return Ico_Diamante }
