...
export default function RedefinicaoSenha({ isEmpresa }) {
  ...
  let dadosSplit = tokenSenha.split("+");
  ...
  function onSubmit(ev) {
    ...
    api
      .get(
        `usuario/redefinirSenha?email=${email}&novaSenha=${DadosUser.password}&tokenUsuario=${tokenUsuario}`,
      )
      .then((response) => {
  ...
  return (
    <>
      ...
      <div
        className="container-sm login-usuario-container"
      ...
      >
        ...
        {IsCarregandoDados ? (
          ...
          <>
            <p className="text-center texto-label-acesso">
            ...
            <form>
              ...
              <button
                ...
                onClick={onSubmit}
                disabled={
                  IsSenhaIgual === true && IsSenhaValida === true ? false : true
                }
              >
                Atualizar senha
              </button>
